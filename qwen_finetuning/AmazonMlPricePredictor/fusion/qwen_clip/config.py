"""
Configuration for Qwen-CLIP Fusion Model
Combines CLIP image embeddings with Qwen text embeddings (includes structural features)
"""
from pathlib import Path


class Config:
    """Configuration parameters for Qwen-CLIP fusion model training"""
    ...
    OUTPUT_DIR = Path("/data/utk/amazon_ml_2025/outputs/fusion_qwen")
    ...
    # Model architecture
    IMAGE_EMB_DIM = 768      # CLIP image embeddings
    TEXT_EMB_DIM = 1027      # Qwen embeddings (1024 text + 3 structural)
    
    # Branch dimensions
    IMAGE_BRANCH_DIMS = [768, 512]       # 768 → 512
    TEXT_BRANCH_DIMS = [1027, 512]       # 1027 → 512 (includes structural info)
    
    # Fusion and regression head
    FUSION_DIM = 512 + 512  # 1024
    ...
    NUM_ATTENTION_HEADS = 8  # Must divide FUSION_DIM (1024/8=128)
